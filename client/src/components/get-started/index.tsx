...
const GettingStarted = () => {
  ...
  return (
    <div className="absolute w-full h-full top-0 left-0 bg-[url(/images/1000_F_561382565_gSbpB8DMRXYK8bM26GOGsGDexeedEBBL-1.png)] bg-cover bg-[10%_10%]">
        <div onClick={handleStart} className="absolute w-full h-[1025px] top-0 left-0 [background:linear-gradient(180deg,rgba(0,0,0,0.4)_0%,rgba(102,102,102,0.4)_80%)]" />
        <div onClick={handleStart} className="absolute w-[279px] h-[53px] top-[600px] left-[calc(100vw-1100px)] bg-white rounded-[25px]" />
        <div onClick={handleStart} className="absolute top-[610px] left-[calc(100vw-1040px)] [font-family:'Literata-Bold',Helvetica] font-bold text-black text-3xl tracking-[0] leading-[normal]">
            Get Started
        </div>
