...
const ActivityCard = ({ activity, onClick }: { activity: any , onClick: any}) => {
  console.log('ActivityCard Props:', activity); // Add this log to verify props

  return (
         <div onClick={onClick(activity)} className="relative w-[850px] h-[172px] bg-white">
            ...
            <div className="w-[326px] h-[46px] top-9 left-[42px] bg-[#d9d9d9] absolute rounded-[17.28px]" />
